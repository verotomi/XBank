...
public class CustomAdapterBankAccounts extends ArrayAdapter<DataModelBankAccounts>{
    ...
    public CustomAdapterBankAccounts(ArrayList<DataModelBankAccounts> data, Context context) {
        super(context, R.layout.row_item_bank_account_balance, data);
        this.dataset = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.row_item_bank_account_balance, parent, false);
