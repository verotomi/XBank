...
public class BeneficiariesNewActivity extends BaseActivity implements PerformNetworkRequest.TaskDelegate{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.TitleNewBeneficiary)); // Fejléc átállítása a kiválasztott nyelver. Ez még a setContentView() elé kell
        setContentView(R.layout.activity_beneficiaries_new);
        ...
        ButtonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (EditTextName.getText().toString().equals("")) {
                    Toast.makeText(BeneficiariesNewActivity.this, R.string.template_name_needed, Toast.LENGTH_SHORT).show();
                    iserror = true;
                }
                else if (EditTextPartnerName.getText().toString().equals("")) {
                    Toast.makeText(BeneficiariesNewActivity.this, R.string.beneficiary_name_needed, Toast.LENGTH_SHORT).show();
                    iserror = true;
                }
                else if (!((EditTextPartnerAccountNumber.getText().toString().length() == 17) || (EditTextPartnerAccountNumber.getText().length() == 26))){
                    //if (true){
                    Toast.makeText(BeneficiariesNewActivity.this, R.string.rule_account_number, Toast.LENGTH_SHORT).show();
                    iserror = true;
                }
                if (iserror) {
                } else {
                    ...
                    Intent intent = new Intent(BeneficiariesNewActivity.this, DoneAnimation.class);
    ...
    public void taskCompletionResult(String result) {
        ...
        switch (returnedMessage) {
            case Constants.RESPONSE_MESSAGE_NEW_BENECICIARY_SUCCESSFUL:
        ...
        if (id == R.id.logout_toolbar_icon_3) {
            ...
            cdd.setCustomObjectListener2(new CustomDialogClass.MyCustomObjectListener2() {
                ...
                public void onYes(String title) {
                    ...
                    //menuitem_toolbar_name.setVisible(false);
                    loginState = false;
                    Utility.saveLoginState(BeneficiariesNewActivity.this, false); // elmentjük a "kilépve" állapotot SharedPrefferences-be
                    MobilBankMainActivity.mobilBankMainActivity.finish(); // MainActivity bezárása
                    Intent intent = new Intent(BeneficiariesNewActivity.this, LogoutAnimation.class);
                    startActivity(intent);
                    Handler handler = new Handler();
                    handler.postDelayed(new Runnable() {
                        public void run() {
                            //Utility.CallNextActivity(MobilBankMainActivity.this, MainActivity.class);
                            BeneficiariesNewActivity.this.finish();
                            //finish();
                        }
                    }, 3000);
                }
        ...
        navigationView.setNavigationItemSelectedListener(
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (id){
                            case R.id.Overviewe:
                                intent = new Intent(BeneficiariesNewActivity.this, MobilBankMainActivity.class); // ez csak azért kellett ide, mert szólt az Android Studio, ha ez nincs
                                ignore = true;
                                finish();
                                break;
                            case R.id.Balance_query:
                                intent = new Intent(BeneficiariesNewActivity.this, BankAccountBalancesActivity.class);
                                break;
                            case R.id.One_time_transfer:
                                intent = new Intent(BeneficiariesNewActivity.this, TransferMoneyOneTimeActivity.class);
                                break;
                            case R.id.Recurring_transfers:
                                intent = new Intent(BeneficiariesNewActivity.this, RecurringTransfersActivity.class);
                                break;
                            case R.id.Savings:
                                intent = new Intent(BeneficiariesNewActivity.this, SavingsActivity.class);
                                break;
                            case R.id.Account_history:
                                intent = new Intent(BeneficiariesNewActivity.this, BankAccountHistoryActivity.class);
                                break;
                            case R.id.Account_statement_download:
                                intent = new Intent(BeneficiariesNewActivity.this, BankAccountStatementsActivity.class);
                                break;
                            case R.id.Beneficiaries:
                                intent = new Intent(BeneficiariesNewActivity.this, BeneficiariesActivity.class);
                                break;
                            case R.id.Manage_credit_cards:
                                intent = new Intent(BeneficiariesNewActivity.this, CreditCardsActivity.class);
                                break;
                            case R.id.Change_PIN_code:
                                intent = new Intent(BeneficiariesNewActivity.this, PinCodeChangeActivity.class);
                                break;
                            case R.id.Logout:
                                //intent=null;
                                ...
                                CustomDialogClass cdd = new CustomDialogClass(BeneficiariesNewActivity.this);
                                cdd.setCustomObjectListener2(new CustomDialogClass.MyCustomObjectListener2() {
                                    @Override
                                    public void onYes(String title) {
                                        menuitem_logout_3.setEnabled(false);
